            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {methods.map((m) => (
                    <button
                        ...
                        className={`flex flex-col p-5 rounded-2xl border-2 text-left transition-all duration-300 ${shipping.method === m.id
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 flex-1">{m.description}</p>
                        <span className="text-sm font-bold text-blue-600 dark:text-blue-400 mt-3">{m.price}</span>
                    </button>
                ))}
            </div>
